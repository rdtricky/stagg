...
<div style="font-family: sans-serif; padding: 0 24px; max-width: 768px; margin: 0 auto;">
    ...
    <div style="text-align: center; margin: 50px 0; color: rgba(255, 255, 255, 0.9);">
        <a href="https://stagg.co/u/confirm?t={jwtToken}" style="box-shadow: 0 10px 10px -5px; text-decoration: none; text-align: center; background: #007bff; color: inherit; font-size: 20px; padding: 6px 32px; outline: none; border: 1px solid #0069d9; border-radius: 4px;">Confirm Email</a>
    </div>
