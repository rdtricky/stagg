export namespace confirm {
    export const discord = (jwtToken:string) => {
            ...
            <div style="font-family: sans-serif; padding: 0 24px; max-width: 768px; margin: 0 auto;">
                <div style="display: block; ${imgSize} margin: 0 auto;">
                    <a href="https://stagg.co">
                        <img alt="StaggBot" src="https://i.imgur.com/XliDTTO.png" 
                            style="display: inline-block; ${imgSize} border-radius: 50%; border: 1px solid #aaa; box-shadow: 0 10px 10px -5px;" />
                    </a>
                </div>
                <div>
                ...
                <p style="font-size: 12px; color: #aaa;">
                    This automated email was sent as a result of a user action at 
                        <a href="https://stagg.co" style="color: inherit; text-decoration: none;">Stagg.co</a>; 
